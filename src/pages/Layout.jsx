          ...
          <SidebarHeader className="border-b border-slate-200/60 p-6">
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <div className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-br from-pink-400 to-orange-400 rounded-full flex items-center justify-center">
                  <Sparkles className="w-2 h-2 text-white" />
                </div>
              </div>
              <div>
                <h2 className="font-bold text-slate-900 text-lg">DataHub</h2>
                <p className="text-xs text-slate-500">Real Data for Designers</p>
              </div>
            </div>
          </SidebarHeader>
